...
const TransactionsCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount }) => {
  ...
  return (
    <div className="white-glassmorphism m-4 flex flex-1
      2xl:min-w-[450px] 2xl:max-w-[500px] sm:min-w-[270px] sm:max-w-[300px] min-w-full
      flex-col p-3 rounded-md hover:shadow-2xl min-h-[250px]"
    >
...
const Transactions = () => {
  ...
  const filteredTransactions = transactions.slice(-5).reverse();
